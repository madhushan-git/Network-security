...
MONO_DB_URL=os.getenv("MONGO_DB_URL")
print(MONO_DB_URL)
...
class NetworkDataExtract():
    ...
    def insert_data_mongodb(self,records,database,collection):
        try:
            ...
            self.mongo_client=pymongo.MongoClient(MONO_DB_URL)
...
if __name__=="__main__":
    ...
    DATABASE="MadhushanAI"
    COLLECTION="NetworkData"
    networkobj=NetworkDataExtract()
    records=networkobj.cv_to_json_convertor(file_path=FILE_PATH)
    print(records)
    n0_of_records=networkobj.insert_data_mongodb(records,DATABASE,COLLECTION)
    print(n0_of_records)